    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative inline-flex p-1 bg-gray-200 rounded-lg">
                <div
                    className={`absolute inset-0 m-1 rounded transition-transform duration-200 ease-in-out ${inputType === "github" ? "translate-x-full" : ""
                        }`}
                    style={{
                        width: "calc(50% - 4px)",
                ...
                <button
                    type="button"
                    className={`relative z-10 px-14 py-4 text-sm text-nowrap font-medium transition-colors duration-200 ${inputType === "file" ? "text-gray-900" : "text-gray-500"
                        }`}
                ...
                <button
                    type="button"
                    className={`relative z-10 px-14 py-4 text-sm text-nowrap font-medium transition-colors duration-200 ${inputType === "github" ? "text-gray-900" : "text-gray-500"
                        }`}
