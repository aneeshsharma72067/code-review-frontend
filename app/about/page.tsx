            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto w-1/2 text-gray-500 text-lg dark:text-gray-400">
                  We aim to streamline and enhance the software development
                  process by providing an intelligent, automated code review
                  system. Our platform leverages cutting-edge AI technology to
                  analyze and review code with speed, accuracy, and consistency.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 border border-gray-200 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  We prioritize code security, helping you identify and fix
                  potential vulnerabilities before they become issues.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border border-gray-200 p-6 rounded-lg shadow-sm">
            ...
            <div className="grid gap-10 lg:grid-cols-2 px-10">
              <div className="space-y-4 bg-blue-100 rounded-lg p-12 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 md:text-lg lg:text-base xl:text-lg">
                  Our AI-powered code review system uses advanced machine
                  learning algorithms to analyze your code and provide
                  actionable insights. Here's how it works:
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center justify-center space-x-2">
                    <BrainIcon className="h-5 w-5 text-blue-500" />
                    <span>
                      AI analyzes your code for patterns and potential issues
                    </span>
                  </li>
                  <li className="flex items-center justify-center space-x-2">
                  ...
                  <li className="flex items-center justify-center space-x-2">
                    ...
                    <span>
                      Learns from your team's coding style and preferences
                    </span>
                  </li>
                </ul>
              </div>
              <div className="space-y-4 bg-green-100 rounded-lg p-12 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 md:text-lg lg:text-base xl:text-lg">
                  AI Code Review offers numerous benefits to development teams
                  of all sizes:
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center justify-center space-x-2">
                  ...
                  <li className="flex items-center justify-center space-x-2">
                    <ArrowRightIcon className="h-5 w-5 text-green-500" />
                    <span>
                      Catch bugs and security issues early in development
                    </span>
                  </li>
                  <li className="flex items-center justify-center space-x-2">
                    <ArrowRightIcon className="h-5 w-5 text-green-500" />
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                  Start your journey to better code quality today with AI Code
                  Review.
                </p>
              </div>
